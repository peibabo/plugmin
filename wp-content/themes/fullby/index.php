<?php get_header(); ?>
		...
		<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 cont-grid">
			...
			<?php if (have_posts()) :?><?php while(have_posts()) : the_post(); ?>
				...
				<div class="item">
					...
					<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<p class="meta"> <i class="fa fa-clock-o"></i> <?php the_time('Y.m.d') ?> &nbsp;
						...
						<a class="thumbnail-img" href="<?php the_permalink(); ?>">
