					...
					<div class="sing-spacer">
						...
						<div class="pagelink">
							<div class="snsshare">
								...
								<a id="share_tw" href="http://twitter.com/intent/tweet?url=<?php echo get_permalink(); ?>&amp;text=<?php the_title();?> <?php bloginfo('name')?> - プラグイン共有メディア" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;">Twitterでシェア</a>
							</div>
							<p>このプラグインにビビっときたらシェア</p>
						</div>
